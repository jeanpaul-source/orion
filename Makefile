.PHONY: lint lint-md format format-check test test-full coverage typecheck check install-hooks dev-setup doc-drift
...
format-check:
	.venv/bin/ruff format --check hal/ tests/ harvest/ eval/
